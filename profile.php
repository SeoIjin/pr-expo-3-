...
$email = isset($_SESSION['email']) ? $_SESSION['email'] : ''; // Default to empty if not set
$name = isset($_SESSION['name']) ? $_SESSION['name'] : ''; // Default to empty if not set
$age = isset($_SESSION['age']) ? $_SESSION['age'] : '';
$usertype = isset($_SESSION['usertype']) ? $_SESSION['usertype'] : ''; // Default to empty if not set
$contact = isset($_SESSION['contact']) ? $_SESSION['contact'] : ''; // Default to empty if not set
